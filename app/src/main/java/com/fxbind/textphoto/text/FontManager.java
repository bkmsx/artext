...
public class FontManager {
	...
	// font) as value.
	private static ArrayList<String> mFontNames;
	...
	public static ArrayList<String> getFontName(){
		return mFontNames;
	}

	static public Pair<String, String> getFirstFont() {
		String[] fontdirs = { "/system/fonts", "/system/font", "/data/fonts" };
		TTFAnalyzer analyzer = new TTFAnalyzer();
		...
		for (String fontdir : fontdirs) {
			...
			for (File file : files) {
				...
				if (fontname != null)
					return new Pair<String, String>(file.getAbsolutePath(),
							fontname);
			}
		}
		return null;
